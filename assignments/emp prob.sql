...
CREATE OR REPLACE SCHEMA AWS_INT.EXT_STAGES;

CREATE STORAGE INTEGRATION s3_pipe
  TYPE = EXTERNAL_STAGE
  STORAGE_PROVIDER = 'S3'
  STORAGE_AWS_ROLE_ARN = 'arn:aws:iam::014679146979:role/kalpana-s3-role'
   ENABLED = TRUE
  STORAGE_ALLOWED_LOCATIONS = ('s3://kalpana-snow-20/emp/');
